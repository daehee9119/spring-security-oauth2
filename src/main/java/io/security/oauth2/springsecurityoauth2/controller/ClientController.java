...
public class ClientController {
    ...
    public String client(HttpServletRequest request, Model model){
        ...
        OAuth2AuthorizedClient authorizedClient1 =
                oAuth2AuthorizedClientRepository.loadAuthorizedClient(clientRegistrationId,
        ...
        OAuth2User oAuth2User =
                oAuth2UserService.loadUser(new OAuth2UserRequest(authorizedClient1.getClientRegistration(), accessToken));
        ...
        model.addAttribute("principleName", oAuth2User.getName());
